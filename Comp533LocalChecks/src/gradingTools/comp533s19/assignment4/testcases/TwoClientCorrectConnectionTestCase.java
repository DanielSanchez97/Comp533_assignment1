...
//				return fail("Server failed to accept connections");
	...
	private static void setupProcesses() {
		...
		BasicExecutionSpecificationSelector.getBasicExecutionSpecification().setEntryTags("Server", Arrays.asList("Server", "GIPC", Comp533Tags.CUSTOM_IPC));
		BasicExecutionSpecificationSelector.getBasicExecutionSpecification().setEntryTags("Client_0", Arrays.asList("Client", "GIPC", Comp533Tags.CUSTOM_IPC));
		BasicExecutionSpecificationSelector.getBasicExecutionSpecification().setEntryTags("Client_1", Arrays.asList("Client", "GIPC", Comp533Tags.CUSTOM_IPC));
