...
@MaxValue(5)
@Explanation("Checks for expected client2 counter output when explicit receive is implemented.")
public class ExplicitReceiveClient2CounterRegularOutput extends ExplicitReceiveClient1CounterRegularOutput {
