...
@MaxValue(10)
@Explanation("Checks for explicit receives in client2 counter output ")
public class ExplicitReceiveClient1CounterReceives extends ExplicitReceiveClient1CounterRegularOutput {

	@Override
	protected SubstringSequenceChecker checker() {
		return new  AnExplicitReceiveClientReceivesChecker(); 
	}
