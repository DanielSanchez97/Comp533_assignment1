...
@MaxValue(10)
@Explanation("Checks that GIPC function returns are not in client2 counter output ")
public class CustomRPCClient1CounterNoGIPCReturnQueue extends CustomRPCClient1CounterRegularOutput {

	@Override
	protected SubstringSequenceChecker checker() {
		return new  ARegularRPCClientReceivesChecker(); 
	}
